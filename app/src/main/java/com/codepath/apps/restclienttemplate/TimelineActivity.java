...
public class TimelineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // adds the scrollListener to RecyclerView
    ...
    // appends the next page of data into the adapter
        ...
        client.getNextPageOfTweets(new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Headers headers, JSON json) {
                ...
                try {
                    ...
                    // notify the adapter of the new items made (already done inside addAll method)
    ...
    // makes request to Twitter API to get home timeline
